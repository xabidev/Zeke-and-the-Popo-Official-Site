    ...
    >
      ...
      >
        <vue-plyr ref="plyr" id="audioPlayer" :options="{ controls: controls }">
          <audio autoplay>
            <source src="~assets/audio/story/mp3/05.mp3" type="audio/mp3" />
            <source src="~assets/audio/story/ogg/05.ogg" type="audio/ogg" />
          </audio>
        </vue-plyr>
      </div>

      <div
        :class="$q.platform.is.mobile ? 'q-px-none q-pt-md bg-zatpp' : 'q-px-none q-pt-none bg-zatpp no-shadow'"
      >
        ...
        <div class="flex flex-center q-py-xl">
          <q-btn color="primary" icon-right="fas fa-video" label="Continue to Video" to="/video" />
        </div>
      </div>
    </q-page>
  </q-pull-to-refresh>
