    ...
    >
      ...
      >
        <vue-plyr ref="plyr" id="audioPlayer" :options="{ controls: controls }">
          <audio autoplay>
            <source src="~assets/audio/story/mp3/04.mp3" type="audio/mp3" />
            <source src="~assets/audio/story/ogg/04.ogg" type="audio/ogg" />
          </audio>
        </vue-plyr>
      </div>
      ...
      >
        ...
        <div class="flex flex-center q-py-xl">
          <q-btn size="md" color="primary" icon="fas fa-forward" to="/story5" />
        </div>
      </div>
    </q-page>
  </q-pull-to-refresh>
